...
class CourseResource extends Resource
{
    ...
    /**
     * Scope every query to the logged-in teacher's own courses.
     */
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('teacher_id', static::currentTeacherId());
    }
    ...
    {
        return [
            CourseResource\RelationManagers\SessionsRelationManager::class,
        ];
    }
