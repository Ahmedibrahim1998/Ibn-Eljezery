...
use App\Filament\Supervisor\Resources\TeacherResource\Pages;
...
class TeacherResource extends Resource
{
    ...
    // Teacher has an admin Shield policy; the supervisor panel manages teachers
    // directly, so bypass that policy here (panel access is already gated by role).
