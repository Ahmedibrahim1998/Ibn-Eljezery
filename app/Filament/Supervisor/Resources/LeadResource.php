...
use App\Filament\Supervisor\Resources\LeadResource\Pages;
use App\Models\Lead;
use Filament\Forms;
...
class LeadResource extends Resource
{
    ...
    /** Only leads whose chosen course is supervised by the logged-in user. */
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->whereHas('course', fn (Builder $q) => $q->where('supervisor_id', Auth::id()));
    }
